...
class PrologQuery(arm.AddressSpaceARM):
    def __init__(self, image_path):
        arm.AddressSpaceARM.__init__(self, image_path, 0, 1)
...
def test():
    ...
    #prolog_query.extract_info(0x3e849048-1000, 'tmp')
    prolog_query.find_tasks2(0xc1e748-3000)
...
def main():
    ...
    paddr = 0xc1e178
    #paddr = 0x3eb54000
    #prolog_query.extract_info(int(paddr), 'tmp')
    prolog_query.start_query(int(paddr), "task_struct")
    return 
